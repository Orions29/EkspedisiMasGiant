...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Bulan Mei 2026 pada 01.55
...
ALTER TABLE `tracking_logs`
  ...
  ADD KEY `idx_tracking_courier` (`courier_id`);
...
--
ALTER TABLE `tracking_logs`
  ADD CONSTRAINT `fk_tracking_courier` FOREIGN KEY (`courier_id`) REFERENCES `users` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
